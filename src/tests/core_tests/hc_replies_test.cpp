...
int test_main(int argc, char ** argv) 
{
	...
	{
		// Good data testing
		RUN_TEST(partial_content_test(0, 1000, 1000), 1000);
		RUN_TEST(partial_content_test(10, 15, 1000), 1000);
		RUN_TEST(partial_content_test(999, 1000, 1000), 1000);
		RUN_TEST(partial_content_test(1, 998, 1000), 1000);
		// Bad data testing
		RUN_TEST(partial_content_test(998, 998, 1000) == false, 1000);
		RUN_TEST(partial_content_test(1000, 1, 1000) == false, 1000);
		RUN_TEST(partial_content_test(1, 1000, 500) == false, 500);
